...
namespace WebApplication4.Models
{
    public abstract class CEntidad:IEnumerable<KeyValuePair<string,object>>
    {
        ...
        public async static Task<int> ExecuteCommand(string Query,List<MySqlParameter>parametros=null)
        {
            try
            {
        ...
        public async static Task<MySqlDataReader> ExecuteReader(string Query)
        {
            try
            {
